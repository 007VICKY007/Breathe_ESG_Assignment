"""
Base Django settings for Breathe ESG ingestion prototype.
"""
import os
...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 50,
    "EXCEPTION_HANDLER": "breathe_esg.exceptions.custom_exception_handler",
...
# Run tasks inline when Redis unavailable (local dev); set CELERY_TASK_ALWAYS_EAGER=0 in prod
...
LOGGING = {
    ...
    "loggers": {
        ...
        "breathe_esg": {"level": "DEBUG", "propagate": True},
    },
}
